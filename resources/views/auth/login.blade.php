...
<body class="flex min-h-screen flex-col-reverse lg:flex-row font-sans">
    ...
    <section class="flex w-full items-center justify-center bg-white px-4 py-10 lg:w-1/2 lg:py-0">
        <div class="w-full max-w-md">
            ...
            <a href="{{ route('auth.auth0.redirect') }}" class="flex w-full items-center gap-3 rounded-lg bg-gpt-600 px-5 py-3 text-left text-white hover:bg-gpt-700 transition-colors">
            ...
            <div class="mt-6 grid grid-cols-3 gap-3">
                <a href="{{ route('auth.socialite.redirect', 'google') }}" class="flex items-center justify-center gap-2 rounded-lg border border-slate-200 px-3 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
                ...
                <a href="{{ route('auth.socialite.redirect', 'microsoft') }}" class="flex items-center justify-center gap-2 rounded-lg border border-slate-200 px-3 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
                ...
                <a href="{{ route('auth.socialite.redirect', 'apple') }}" class="flex items-center justify-center gap-2 rounded-lg border border-slate-200 px-3 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
