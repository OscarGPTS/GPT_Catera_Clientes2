    ...
    <section class="flex w-full items-center justify-center bg-white px-4 py-10 lg:w-1/2 lg:py-0">
        <div class="w-full max-w-md">
            ...
            <div class="flex flex-col items-center mb-6">
                ...
                <p class="text-center text-sm text-slate-500">Inicia sesión para acceder a la plataforma</p>
            </div>
            ...
            <div class="mt-6">
                <a href="{{ route('auth.socialite.redirect', 'google') }}" class="flex w-full items-center justify-center gap-3 rounded-lg border border-slate-200 px-4 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors">
